...
import com.example.myapplication1.databinding.ItemHistoryRowBinding

class HistoryAdapater(private val items:ArrayList<String>): RecyclerView.Adapter<HistoryAdapater.ViewHolder>() {
